"""
Django settings for damp_thunder_dev_110239 project.
...
ROOT_URLCONF = 'damp_thunder_dev_110239.urls'
...
WSGI_APPLICATION = 'damp_thunder_dev_110239.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_thunder_dev_110239 API",
    "DESCRIPTION": "API documentation for damp_thunder_dev_110239 App",
    "VERSION": "v1",
}
